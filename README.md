# First slip into React

My experimentation on [Vedovelli](https://www.youtube.com/channel/UC1PUtdA_NktdtmRpF_UGG_w) intro to React.

[Introdução ao React - parte 1](https://www.youtube.com/watch?v=SeLLxD3ibbU)

[Introdução ao React - parte 2](https://www.youtube.com/watch?v=agnAk8ay2gM)

[api.github.com/users/vedovelli](https://api.github.com/users/vedovelli)

Yes, I did learn a couple things and spent a couple of... minutes... trying to learn such things :)

## How can a readme be so ~~bloated~~ rich in information
## ↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓⬇↓
